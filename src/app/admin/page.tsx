...
export default function ModernDashboard() {
  ...
  //   { month: "Jan", ldrp: 3.5, kb: 3.2, cmp: 3.1 },
  //   { month: "Feb", ldrp: 3.8, kb: 3.4, cmp: 3.3 },
  //   { month: "Mar", ldrp: 4.0, kb: 3.6, cmp: 3.4 },
  //   { month: "Apr", ldrp: 3.9, kb: 3.5, cmp: 3.2 },
  //   { month: "May", ldrp: 4.2, kb: 3.8, cmp: 3.5 },
  //   { month: "Jun", ldrp: 4.2, kb: 3.8, cmp: 3.5 },
  // ];
  const revenueGrowthData = [
    { month: "Jan", ldrp: 4.5, kb: 3.5, cmp: 2.8 },
    { month: "Feb", ldrp: 5.0, kb: 3.8, cmp: 3.0 },
    { month: "Mar", ldrp: 5.4, kb: 4.1, cmp: 3.3 },
    { month: "Apr", ldrp: 5.2, kb: 4.0, cmp: 3.1 },
    { month: "May", ldrp: 5.7, kb: 4.3, cmp: 3.4 },
    { month: "Jun", ldrp: 5.9, kb: 4.5, cmp: 3.6 },
  ];
  ...
  const universityHighlights = [
    {
      category: "Placement",
      title: "Campus Drive",
      text: "120 students placed this week.",
      priority: "high",
    ...
    },
    {
      category: "Research",
      title: "AI Grant",
      text: "₹25L awarded for AI project.",
      priority: "medium",
    ...
    },
    {
      ...
      title: "Hackathon Win",
      text: "Team won Smart India 2025.",
      priority: "high",
    ...
    <DashboardLayout theme={currentTheme} setTheme={setCurrentTheme}>
      <div className="p-6 space-y-6">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <h1 className={`${themeConfig.text}`}>Dashboard Overview</h1>
                ...
                <AreaChart data={revenueGrowthData}>
                  <defs>
                    ...
                    >
                      <stop
                        offset="5%"
                        stopColor={themeConfig.tertiary.fill}
                        stopOpacity={0.8}
                      />
                      <stop
                        offset="95%"
                  ...
                  <Area
                    ...
                    dataKey="cmp"
                    name="CM Patel"
                    stroke={themeConfig.tertiary.stroke}
